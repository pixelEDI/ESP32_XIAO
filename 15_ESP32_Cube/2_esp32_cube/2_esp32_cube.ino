...
Original Library https://github.com/playfultechnology/esp32-smartcube/blob/master/esp32-smartcube.ino
...
static BLEAddress *pServerAddress = new BLEAddress("c3:b9:92:69:58:c4");
...
const byte solution[16] = {0x12, 0x38, 0x56, 0x74, 0x13, 0x32, 0x33, 0x31, 0x12, 0x34, 0x56, 0x79, 0x8a, 0xbc, 0x01, 0x80};
...
static void notifyCallback(BLERemoteCharacteristic *pBLERemoteCharacteristic, uint8_t *pData, size_t length, bool isNotify)
{
  ...
  // Serial Print slows down the Bluetooth connection if no Serial Monitor is available
  ...
  /// -------- Edit from original Code ---------------- ///

  // after firststart counter moves = 0 and time is counting
  if (moves == 0)
  {
    startTime = millis();
  ...
  if (memcmp(pData, solution, 16) == 0)
  {
    ...
    Serial.print("SOLVED! Needed Moves: ");
    Serial.print(moves);
    Serial.print(" Time: ");
    Serial.println(solvingTime);
    ...
    client.publish("cube/results", buffer);
